  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center justify-items-center">
          {/* Content */}
          <div className="text-center lg:text-left space-y-6 px-4 sm:px-0">
            ...
            <RevealAnimation direction="up" delay={1.1}>
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start px-4 sm:px-0">
